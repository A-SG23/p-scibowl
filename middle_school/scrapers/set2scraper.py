...
pdf_urls = [
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r1.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r2.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r3.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r4.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r5.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r6.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r7.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r8.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r9.pdf',
    'https://science.osti.gov/-/media/wdts/nsb/pdf/MS-Sample-Questions/Sample-Set-2/sample_questions_r10.pdf'
]
...
def cleanUnwanted(text):
    ...
    return re.sub(r'Junior National Science Bowl Round Robin\s*\d+\s*Page\s*\d+', '', text, flags=re.IGNORECASE).strip()
...
for i, url in enumerate(pdf_urls, 1):
    ...
    output_csv = f"middle_school/raw_data/set2round{i}.csv" #CHANGE THE SET NUMBER!!!!!
